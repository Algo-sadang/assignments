...
public class Q2636_Huipyo_Hong {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            time++;
            bfs(grid, new AbstractMap.SimpleEntry<>(0, 0));
        }
        scanner.close();
    }

    private static void bfs(int[][] grid, AbstractMap.SimpleEntry<Integer, Integer> start) {
        Queue<AbstractMap.SimpleEntry<Integer, Integer>> queue = new ArrayDeque<>(List.of(start));
        Set<AbstractMap.SimpleEntry<Integer, Integer>> visited = new HashSet<>(List.of(start));
